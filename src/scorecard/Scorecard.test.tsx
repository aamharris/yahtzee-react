...
describe('Scorecard', () => {
    ...
    it('shows total for lg straight when lg straight is rolled', () => {
        const dice = new DiceBuilder().addDice({value: 1})
        .addDice({value: 2}).addDice({value: 3}).addDice({value: 4}).addDice({value: 5}).build();
        render(<Scorecard dice={dice} />);
    ...
    it('shows total for sm straight when roll has sm straight', () => {
        const dice = new DiceBuilder().addDice({value: 1})
        .addDice({value: 2}).addDice({value: 3}).addDice({value: 4}).addDice({value: 6}).build();
        render(<Scorecard dice={dice} />);
